...
[[ -n "${XWORKMATE_ACCOUNT_BASE_URL:-}" ]] && BUILD_ARGS+=("--dart-define=XWORKMATE_ACCOUNT_BASE_URL=${XWORKMATE_ACCOUNT_BASE_URL}")
[[ -n "${XWORKMATE_MANAGED_BRIDGE_URL:-}" ]] && BUILD_ARGS+=("--dart-define=XWORKMATE_MANAGED_BRIDGE_URL=${XWORKMATE_MANAGED_BRIDGE_URL}")
